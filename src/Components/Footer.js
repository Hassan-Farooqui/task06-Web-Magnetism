        ...
        <div className="flex flex-wrap justify-between gap-y-8">
          ...
          <div className="w-full md:w-1/5 mb-8 md:mb-0">
            <div className="flex items-center mb-4">
              ...
              <a
                href="#"
                className="absolute top-0 left-0 bg-gradient-to-r from-purple-600 to-orange-400 text-white font-semibold px-6 py-2 rounded-full flex items-center justify-center hover:opacity-90 transition"
              >
                <img src="/web.png" alt="Web" className="w-6 h-6 mr-2" />
              </a>
            </div>
          </div>
